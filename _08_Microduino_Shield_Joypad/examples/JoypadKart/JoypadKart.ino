/*
 ...
 This sketch turns the Joypad into a PC game pad.
 ...
 a game that has keyboard input, the Joypad can control it.
...
/*
 ...
 the method Joypad.readButton(x), where x
...
void loop() { 
  ...
  for (byte thisButton=0; thisButton<8; thisButton++) {
    ...
    boolean newState = Joypad.readButton(buttons[thisButton]);
